...
export const OWASP_LLM_RED_TEAM_MAPPING= {
  /**
...
export const DEFAULT_PLUGINS = Array.from(
  new Set([
    ...BASE_PLUGINS,
...
export const ALL_PLUGINS = Array.from(
  new Set([
    ...DEFAULT_PLUGINS,
    ...ADDITIONAL_PLUGINS,
...
const _ALL_STRATEGIES = ['default', ...DEFAULT_STRATEGIES, ...ADDITIONAL_STRATEGIES];
