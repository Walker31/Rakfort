...
import { useRedTeamConfig } from '../../../redteam/setup/hooks/useRedTeamConfig';

const PolicyInput = memo(({ id, value, onChange }) => {
...
export const CustomPoliciesSection = () => {
  ...
  const handlePolicyChange = useCallback((policyId, newValue) => {
